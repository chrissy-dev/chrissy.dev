...
Her reply made me realise that at the time I was very caught up in finding the perfect notes app/tool. I’d spend an unhealthy amount of time researching about privacy, cloud syncing, subscriptions, markdown vs no markdown, is it exportable etc etc..
...
[PreText](https://itunes.apple.com/au/app/pretext/id1347707000) I was surprised at the lack of offerings on the App Store for a basic text editing application that didn’t want to control my files. Apple have yet to create a plain text editor for iOS (no idea why) but [PreText](https://itunes.apple.com/au/app/pretext/id1347707000) has been created to be just that. It’s nothing fancy but pulls together a few native iOS components to basically bring TextEdit to iOS. 
